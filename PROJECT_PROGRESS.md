...
- 当前源码范围：任务 1 的包基座与测试入口、任务 2 的确定性动作协议/离线 Mock LLM，以及任务 3 的确定性策略、规则与失败关闭路径沙箱已完成并经审查；尚未开始命令审批、AgentLoop、工具、反馈、记忆、API、凭据、上传、前端、CI、容器或部署。
